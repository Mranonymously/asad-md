...
async (conn, mek, m, { from, sender, isGroup, reply, quoted, participants }) => {
    try {
        ...
        try {
            ...
            ppUrl = 'https://h.uguu.se/KsZZhDfs.jpeg';
        }
...
if (!isAdmins) return reply('You Are Not A Admin')	
  if (args[1] == 'second') {
                ...
                setTimeout(() => {
                    ...
                    const open = `*OPEN TIME* THE GROUP WAS OPENED BY ASAD MD TO APPROVED ADMIN\n NOW MEMBERS CAN SEND MESSAGES 🔓`
...
if (!isAdmins) return reply('You Are Not A Admin')	
                ...
                setTimeout(() => {
                    ...
                    const close = `*CLOSE TIME* GROUP CLOSED BY ASAD MD AT APPROVED ADMIN\nNOW ONLY ADMIN CAN SEND MESSAGES 🔐`
...
await conn.sendMessage(from, { react: { text: `✅`, key: mek.key }}) 
reply('*GROUP ADMIN PROMOTE BY ASAD-MD BOT OWNER*')
} catch (e) {
reply('*ERROR*')
console.log(e)
}
...
await conn.sendMessage(from, { react: { text: `✅`, key: mek.key }})
reply('*GROUP ADMIN DEMOTE BY ASAD-MD BOT OWNER*') 
} catch (e) {
reply('*ERROR*')
console.log(e)
}
