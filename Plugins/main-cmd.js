...
async (conn, mek, m, { from }) => {
    try {
        ...
        const ownerNumber = '+923359216317'; // Replace this with the actual owner number
        const ownerName = 'ASADMD Official'; // Replace this with the owner's name
        const organization = 'ASAD CODERS'; // Optional: replace with the owner's organization
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                mentionedJid: [ownerNumber.replace('+923359226317', '') + '+923359216317@s.whatsapp.net'], // Mention the owner
...
try{
let dec = `> ASAD-MD REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ ASAD-MD REPO: ${bot.REPO_LINK} 
┃
